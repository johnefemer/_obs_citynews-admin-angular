...
export class AccountInformationComponent implements OnInit, OnDestroy {
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      ...
      email: [this.user.primary_email, Validators.compose([Validators.required, Validators.email])],
      language: [this.user.details.language],
      timeZone: [this.user.details.timezone],
